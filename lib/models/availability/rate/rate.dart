...
class Rate {
  ...
  Map<String, dynamic> toJson({num commission = 0}) => {
    ...
    'boardCode': boardCode,
    'boardName': boardName,
    'cancellationPolicies': cancellationPolicies?.map((x) => x.toJson(commission: commission)).toList(),
    'rooms': rooms,
    'adults': adults,
    'children': children,
    'rateKey': rateKey,
  ...
  String toJsonCompress({num commission = 0}) {
    return [
          ...
          boardCode,
          boardName,
          cancellationPolicies?.map((x) => x.toJsonCompress(commission: commission)).toRed("Cancellation"),
          rooms,
          adults,
          children,
          rateKey,
